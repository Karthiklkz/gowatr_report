    ...
    <!-- Content Header (Page header) -->
	  <div class="content-header d-none d-md-block">
			<div class="d-flex align-items-center">
				<div class="mr-auto">
					<h3 class="page-title br-0">Brownstone C</h3>
				</div>
          ...
          <div class="box">
            ...
            <div class="box-body">
				<div class="table-responsive">
				  <table id="brownstonec" class="table table-bordered table-hover display nowrap margin-top-10 w-p100">
					<thead>
						<tr>
							<th>id</th>
                    ...
                    <script>
                        $(document).ready(function() {
                            $('#brownstonec').DataTable({
                                    "ajax": {
                                        "url": "api/api_call.php?id=brownstonec", // Path to your PHP script fetching data
                                        "type": "GET",
                                        "dataType": "json",
