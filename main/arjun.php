        ...
        <div class="content-wrapper">
            ...
            <div class="content-header d-none d-md-block">
                <div class="d-flex align-items-center">
                    <div class="mr-auto">
                        <h3 class="page-title br-0">Arjun Flats</h3>
                    </div>
                        ...
                        <div class="box">
                            ...
                            <div class="box-body">
                                <div class="table-responsive">
                                    <table id="arjun" class="table table-bordered table-hover display nowrap margin-top-10 w-p100">
                                        <thead>
										<tr>
						<th>id</th>
							<th>Data</th>
							...
							<th>Version</th>
                                    ...
                                    <script>
                                        $(document).ready(function() {
                                            $('#arjun').DataTable({
                                                "ajax": {
                                                    "url": "api/api_call.php?id=arjun", // Path to your PHP script fetching data
                                                    "type": "GET",
                                                    "dataType": "json",
