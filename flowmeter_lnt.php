        ...
        <div class="content-wrapper">
            ...
            <div class="content-header d-none d-md-block">
                <div class="d-flex align-items-center">
                    <div class="mr-auto">
                        <h3 class="page-title br-0"> L&T</h3>
                    </div>
                        ...
                        <div class="box">
                            ...
                            <div class="box-body">
                                <div class="table-responsive">
                                    <table id="flowmeter_lnt" class="table table-bordered table-hover display nowrap margin-top-10 w-p100">
                                        <thead>
										<tr>
						<th>id</th>
							<th>Project_id</th>
							...
							<th>Version</th> -->
                                    ...
                                    <script>
                                        $(document).ready(function() {
                                            $('#flowmeter_lnt').DataTable({
                                                "ajax": {
                                                    "url": "api/api_call.php?id=lnt", // Path to your PHP script fetching data
                                                    "type": "GET",
                                                    "dataType": "json",
